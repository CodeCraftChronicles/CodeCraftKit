using Core.CoreFeatures.Security.Models.Audit;
...
public abstract class AuditableContext : IdentityDbContext<UserAccount, AccountRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, AccountRoleClaim, IdentityUserToken<string>>
{
